...
export default function SearchEngine(props) {
  ...
  const handleGoogle = (search) => {
    let baseUrl = 'https://www.google.co.uk/search?q='
    window.location = baseUrl + encodeURIComponent(search)
  }

  const handleDuckDuckGo = (search) => {
    let baseUrl = 'https://duckduckgo.com/?q='
    window.location = baseUrl + encodeURIComponent(search)
  }

  const handleReddit = (search) => {
  ...
  switch(props.engine) {
    ...
    case "google":
      button = <button className="google" title="Google" onClick={() => {
        handleGoogle(props.search)
      }}><svg
        fill="currentColor"
        viewBox="0 0 16 16"
        height="1em"
    ...
    case "duckduckgo":
      button = <button className="duckduckgo" title="DuckDuckGo" onClick={() => {
        handleDuckDuckGo(props.search)
      }}><svg
        viewBox="0 0 24 24"
        fill="currentColor"
        height="1em"
    ...
    case "reddit":
      button = <button className="reddit" title="Reddit" onClick={() => {
        handleReddit(props.search)
      }}><svg
